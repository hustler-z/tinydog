...
#define BUILD_USER           __stringify(__BUILD_USER__)

#define BUILD_HOST           __stringify(__BUILD_HOST__)

#define SHELL_VERSION        __stringify(__SHELL_VERSION__)

#define USER_REPO_VERSION    __stringify(__USER_REPO_VERSION__)

#define USER_PROMPT          __stringify(__PROMPT__)
