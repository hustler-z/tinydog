...
use crate::board::{
	ClusterDesc, PlatCpuConfig, PlatCpuCoreConfig, PlatMemRegion,
	PlatMemoryConfig, PlatOperation, Platform, PlatformConfig,
};
...
pub const PLAT_DESC: PlatformConfig = PlatformConfig {
	...
	mem_desc: PlatMemoryConfig {
		regions: &[
			// reserve 0x80200000 ~ 0x88200000 for Tinyvm
			PlatMemRegion {
				base: 0x80200000,
				size: 0x08000000,
			},
