...
use crate::arch::{
	GicState, ACTLR_EL1, AMAIR_EL1, CNTKCTL_EL1, CNTP_CTL_EL0, CNTP_TVAL_EL0,
	CNTVCT_EL0, CNTVOFF_EL2, CNTV_CTL_EL0, CNTV_CVAL_EL0, CNTV_TVAL_EL0,
	CONTEXTIDR_EL1, CPACR_EL1, ELR_EL1, ESR_EL1, FAR_EL1, GICD, HCR_EL2,
	MAIR_EL1, PAR_EL1, PMCR_EL0, SCTLR_EL1, SP_EL0, SP_EL1, TCR_EL1,
	TPIDRRO_EL0, TPIDR_EL0, TPIDR_EL1, TTBR0_EL1, TTBR1_EL1, VBAR_EL1,
	VMPIDR_EL2,
};
...
impl GicContext {
	pub fn add_irq(&mut self, id: u64) {
		...
		self.irq_state[idx].enable =
			((GICD.is_enabler(id as usize / 32) >> (id & 32)) & 1) as u8;
