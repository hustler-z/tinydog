...
use crate::init;
use crate::kernel::{
	cpu_map_self, CpuState, CPU_IF_LIST, CPU_STACK_OFFSET, CPU_STACK_SIZE,
};
...
pub static mut BOOT_STACK: BootStack =
	BootStack([0; BOOT_STACK_SIZE * MAX_CPU]);
...
pub fn riscv_init(
	...
	let new_stack = current_cpu_arch()
		+ (CPU_STACK_OFFSET + CPU_STACK_SIZE) as u64
