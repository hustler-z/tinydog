...
use crate::device::{
    ...
    virtio_net_handle_ctrl, virtio_net_notify_handler, EmuContext, EmuDev, EmuDeviceType,
};
...
use crate::kernel::{current_cpu, ipi_send_msg, vm_ipa2pa, IpiInnerMsg, IpiIntInjectMsg, IpiType};
